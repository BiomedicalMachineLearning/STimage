...
# Load Tiles
data_1160920F = sc.read_h5ad("/QRISdata/Q1851/Xiao/Wiener_backup/STimage_exp/stimage_LOOCV_9visium_selected_gene/pred_1160920F.h5ad")
data_1160920F.obs["tile_path"] = Path+"tiles/tiles/"+data_1160920F.obs["tile_path"].str.split('/', expand=True)[7]
Selection_region_1160920F = list(data_1160920F.obs["tile_path"])
gene_list = list(data_1160920F.var_names)

# Load model
model_weights = "/QRISdata/Q1851/Xiao/Wiener_backup/STimage_exp/stimage_LOOCV_9visium_selected_gene/stimage_model_1160920F.h5"
...
# Run LIME Function
LIMEMask_1160920F_CD24 = LIME_reg_exceptional_handling(Selection_region_1160920F,gene_list[551])
np.save(Path+"Outputs/pickle/pkl/LIMEMaskReg_1160920F_CD24_all.npy",LIMEMask_1160920F_CD24)

LIMEMask_1160920F_CD52 = LIME_reg_exceptional_handling(Selection_region_1160920F,gene_list[26])
np.save(Path+"Outputs/pickle/pkl/LIMEMaskReg_1160920F_CD52_all.npy",LIMEMask_1160920F_CD52)
