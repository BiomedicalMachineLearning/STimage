...
FFPE_C3_ShapMask = SHAP_global(Selection_region_ffpe_1+Selection_region_ffpe_2,gene_list[5])
#FFPE_C3_ShapMask_scaled = SHAP_scale(FFPE_C3_ShapMask,555)
with open(Path+'SHAP_GlobalAgnostic/FFPE_C3_ShapMask_scaled', "wb") as fp:
    pickle.dump(FFPE_C3_ShapMask, fp)

FFPE_GNAS_ShapMask = SHAP_global(Selection_region_ffpe_1+Selection_region_ffpe_2,gene_list[9])
#FFPE_GNAS_ShapMask_scaled = SHAP_scale(FFPE_GNAS_ShapMask,555)
with open(Path+'SHAP_GlobalAgnostic/FFPE_GNAS_ShapMask_scaled', "wb") as fp:
    pickle.dump(FFPE_GNAS_ShapMask, fp)
    
F1160920_C3_ShapMask = SHAP_global(Selection_region_F1160920_1+Selection_region_F1160920_2,gene_list[5])
#F1160920_C3_ShapMask_scaled = SHAP_scale(F1160920_C3_ShapMask,325)
with open(Path+'SHAP_GlobalAgnostic/F1160920_C3_ShapMask_scaled', "wb") as fp:
    pickle.dump(F1160920_C3_ShapMask, fp)

F1160920_GNAS_ShapMask = SHAP_global(Selection_region_F1160920_1+Selection_region_F1160920_2,gene_list[9])
#F1160920_GNAS_ShapMask_scaled = SHAP_scale(F1160920_GNAS_ShapMask,325)
with open(Path+'SHAP_GlobalAgnostic/F1160920_GNAS_ShapMask_scaled', "wb") as fp:
    pickle.dump(F1160920_GNAS_ShapMask, fp)
