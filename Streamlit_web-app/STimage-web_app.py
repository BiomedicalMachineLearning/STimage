...
if app_mode =="LIME":
    ...
    if lime_option == "Classification":    
        ...
        if filename_2 is not None:
            ...
            explainer_tabular = lime_tabular.LimeTabularExplainer(np.array(pd.read_csv(Path+'/files/Transformed_gene_exp.csv')), feature_names=gene_exp_names, class_names=['0','1'], mode='classification')
...
if app_mode == "Meet the Team":
    ...
    team_img = Image.open(Path+'/Meet_the_team.png')
