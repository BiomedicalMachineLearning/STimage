...
adata_all.obs["tile_path"] = adata_all.obs.tile_path.map(lambda x:x.replace("/clusterdata/uqxtan9/Xiao/breast_cancer_9visium/", "/clusterdata/uqxtan9/Xiao/dataset_breast_cancer_9visium/"))
...
train_gen_ = train_gen.shuffle(buffer_size=500).batch(8).repeat(1).cache().prefetch(tf.data.experimental.AUTOTUNE)
...
valid_gen_ = valid_gen.shuffle(buffer_size=500).batch(8).repeat(1).cache().prefetch(tf.data.experimental.AUTOTUNE)
...
pred_adata.write_h5ad("/clusterdata/uqxtan9/Xiao/STimage/development/stimage_benchmarking_1000hvg_OOD/stimage_pred_adata.h5ad")
test_dataset.write_h5ad("/clusterdata/uqxtan9/Xiao/STimage/development/stimage_benchmarking_1000hvg_OOD/stimage_test_adata.h5ad")
...
df.to_csv("/clusterdata/uqxtan9/Xiao/STimage/development/stimage_benchmarking_1000hvg_OOD/stimage_cor_{}.csv".format(test_sample))
